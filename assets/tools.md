...
|[SniffCon](https://github.com/h33tlit/SniffCon-Ultimate-Recon-Dashboard-For-Bug-Bounty-And-Pentesting)|SniffCon is a platform where you will find heavy lifting tools such as subdomain scanner, link scraper, secret finder, whois monitoring and many more that provide you with organized recon data, which is crucial during bug bounty and pentest.|Python|[Jubaer Alnazi](https://github.com/h33tlit)|
